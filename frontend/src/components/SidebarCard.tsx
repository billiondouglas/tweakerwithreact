    ...
    <div className="panel" style={{padding:16}}>
        ...
        <div style={{display:"flex", flexDirection:"column", alignItems:"center", marginTop:-24, gap:8}}>
          ...
          <div style={{textAlign:"center"}}>
            <div style={{ fontWeight: 700, color: "var(--bold-text)" }}>Yeremias NJ</div>
            <div style={{ color: "var(--muted)", fontWeight: 300 }}>@notojoyoo</div>
          </div>
        </div>
      ...
      <div style={{ textAlign: "center", marginTop: 12 }}>
        <a href="/profile" style={{ color: "var(--primary)", textDecoration: "none", fontWeight: 600, cursor: "pointer" }}>
          My Profile
        </a>
      </div>
    </div>
